...
sources:
  ...
  - Michael Mendle, forthcoming history of stenography (as cited by Blair)
review_count: 0
review_interval:
last_reviewed:
notes:
...
Between the disappearance of [[AI Wiki - PKM - Tironian Notes|Tironian notes]] in the 12th century and the systematization of modern shorthand (Pitman 1837, Gregg 1888, German stenography ca. 1834), Europe reinvented shorthand piecemeal, largely in England, primarily for commercial rather than pedagogical use. **Early modern stenography** fills a roughly 300-year gap in which notation systems spread through courtrooms, pulpits, theatres, and parliaments — capturing oral performance for profitable publication — without yet producing the standardized systems that would come later.

## The Gap and Its Refilling

For seven centuries after the last use of Tironian notes, Europe had no functioning full-speed shorthand system. [[AI Wiki - PKM - Reportatio and Reportationes|Reportatio]] with personal abbreviations covered some of the gap for scholarly and ecclesiastical note-taking, but reporting the "very words" of speech remained out of reach for most note-takers most of the time.
...
Notably, early modern stenography barely touched pedagogical note-taking. Students in arts faculties still took notes under [[AI Wiki - PKM - Dictation as Pedagogy|dictation]] or via [[AI Wiki - PKM - Reportatio and Reportationes|reportatio]] well into the 18th and 19th centuries. Kant's anthropology lectures (1772+) and Hegel's Berlin lectures (1820s) were captured through team-based methods and freely reformulating Reinschriften, not through stenography.

Why? Likely because:

- Stenography was **commercial** — tied to publication profits, not classroom understanding
- The [[AI Wiki - PKM - Writing Aids Retention|writing-aids-retention]] principle argued that *effortful* full-text copying was pedagogically valuable; stenography undermined the effort
