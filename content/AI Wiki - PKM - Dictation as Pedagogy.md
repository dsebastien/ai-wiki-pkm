...
In dictation, the master reads or delivers a text slowly enough that students can write it down verbatim. The resulting student manuscript is a full-text *Reinschrift* (see [[AI Wiki - PKM - Mitschrift and Reinschrift]]) rather than a sketchy *reportatio*. Dictation in medieval and early modern usage covered:
...
- The [[AI Wiki - PKM - Voice-to-Knowledge Pipeline|voice-to-knowledge pipeline]]
