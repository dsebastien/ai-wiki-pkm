...
sources:
  ...
  - Jürgen Leonhardt, study of annotated Sammelbände from Leipzig ca. 1500
review_count: 0
review_interval:
last_reviewed:
notes:
...
Jürgen Leonhardt's study of thousands of annotated Sammelbände from Leipzig ca. 1500, cited by Blair, demonstrates that **these annotations were typically written under dictation**: multiple surviving copies from the same classroom contain *identical* sets of notes keyed to *identical* passages. The careful script and elaborate layout indicate they were Reinschriften rather than [[AI Wiki - PKM - Mitschrift and Reinschrift|Mitschriften]] — clean copies produced during class at slow delivery speed, not live capture.
...
- **Anchored vs. atomic notes.** [[AI Wiki - PKM - Atomic Notes|Atomic notes]] detach the idea from its source; Sammelband marginalia keep them fused. Both have costs. Detached notes are reusable but lose context. Anchored notes preserve context but are harder to recombine.
