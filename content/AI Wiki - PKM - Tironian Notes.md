...
The loss is worth noting: a functioning technology for capturing speech at normal speed existed, was used at scale, and was then forgotten for roughly seven hundred years. Medieval reporters reinvented partial solutions ([[AI Wiki - PKM - Reportatio and Reportationes|reportatio]] with personal abbreviations), but nothing equivalent to Tironian notes reappeared until the development of modern shorthand (Pitman 1837, Gregg 1888, German stenography ca. 1834).

## The Coordination Pattern

The Senate-recording case is the earliest documented instance of a pattern that reappears in the [[AI Wiki - PKM - Schreibechor (Writing Chorus)|Schreibechor]] seventeen centuries later: **when speech exceeds individual capture bandwidth, coordinate multiple scribes**. Roman teams pooled notes using short-term recall; Francke's teams rotated through 8-10-word fragments with explicit sequence markers. The underlying constraint — human writing speed — has not changed; what has changed is the sophistication of the coordination protocol.
