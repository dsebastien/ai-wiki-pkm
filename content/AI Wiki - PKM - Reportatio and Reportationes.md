...
sources:
  ...
  - Jacqueline Hamesse, 'La technique de la réportation' (1997)
  - Nicole Bériou, 'La réportation des sermons parisiens' (1989); 'Les sermons latins'
review_count: 0
review_interval:
last_reviewed:
notes:
...
1. **First-order notes** (German: *Mitschriften*): messy, incomplete, taken live on wax tablets, *schedulae* (cheap parchment scraps), or paper. These were considered disposable. They almost never survive.
2. **Clean copies** (*Reinschriften* or *Nachschriften*): produced later in a careful hand, with considered layout, supplemented from memory and from the notes of other listeners or from the speaker's own manuscript. These are what has come down to us.

The German terminological split between *Mitschrift* and *Reinschrift* has no crisp English equivalent but is analytically essential: most surviving "reportationes" are not transparent records of the oral event but reconstructions several removes away. The atomicity of a modern [[AI Wiki - PKM - Atomic Notes|atomic note]] is distant kin to this Reinschrift ideal — clean, durable, rearranged after the fact.
...
- **Synthesis over transcription**: reporters extracted structure (divisions, gist) rather than verbatim text. This is [[AI Wiki - PKM - Note-Making vs Note-Taking|note-making, not note-taking]].
- **Collaborative capture**: pooling notes across listeners to reconstruct a full record prefigures collaborative knowledge capture (see also [[AI Wiki - PKM - Schreibechor (Writing Chorus)]]).
